...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, Instant.parse("2023-01-03T15:30:05Z"), "Partiu Viagem", "Vou viajar para São Paulo. Abraços!", u1);
		Post post2 = new Post(null, Instant.parse("2023-01-03T19:50:30Z"), "Bom dia", "Acordei feliz hoje!", u1);
